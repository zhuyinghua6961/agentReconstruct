...
Shared config owns common Redis defaults and model endpoint aliases that gateway-side
workers may need. Process environment values still override both shared and service-local
env files.
