...
def test_stage1_cache_round_trip_and_lock_key_shape(monkeypatch):
    ...
    assert key.startswith("agentcode:cache:qa:stage1:7:kb_qa:qwen-test:")
    assert lock_key.startswith("agentcode:lock:qa:stage1:7:kb_qa:qwen-test:")
...
def test_stage2_cache_round_trip(monkeypatch):
    ...
    assert key.startswith("agentcode:cache:qa:stage2:2:9:1:kb_qa:qwen-test:6:")
