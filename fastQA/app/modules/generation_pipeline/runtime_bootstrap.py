...
def resolve_generation_runtime_inputs(
    *,
    ...
    resolved_api_key = api_key or _env_first("OPENAI_API_KEY", "DASHSCOPE_API_KEY")
    resolved_base_url = base_url or _env_first("OPENAI_BASE_URL", "DASHSCOPE_BASE_URL")
    resolved_model = model or _env_first("OPENAI_MODEL", "DASHSCOPE_MODEL", default="qwen-plus")
    ...
    if embedding_api_url is None:
        embedding_api_url = _env_first("EMBEDDING_API_URL")
