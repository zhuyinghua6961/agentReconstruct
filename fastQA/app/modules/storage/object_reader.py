...
_SERVICE_LABEL = "fastQA"
_LOGGER = logging.getLogger("fastqa.storage.object_reader")
...
def _default_runtime_root() -> Path:
    configured = str(os.getenv("FASTQA_UPLOAD_CACHE_DIR") or os.getenv("FASTQA_SERVICE_RUNTIME_ROOT") or "").strip()
    base = Path(configured).expanduser() if configured else Path(tempfile.gettempdir()) / "fastqa-object-cache"
