    ...
    <div class="modal">
      ...
      <div class="modal-body">
        ...
        <div class="template-section">
          ...
          <p class="hint">模板列为一级部门名称、一级状态、二级部门名称、二级状态、三级部门名称、三级状态；系统同时兼容旧英文列名。</p>
        </div>
        ...
        <div class="info-section">
          ...
          <ul class="info-list">
            <li>每一行都必须填写一级部门名称、一级状态、二级部门名称、二级状态。</li>
            <li>如果要导入三级部门，必须同时填写三级部门名称和三级状态；两列都留空则只维护到二级。</li>
            ...
            <li>同一一级部门在同一文件中的一级状态必须保持一致，否则冲突行会失败。</li>
            <li>完全重复的行会被标记为跳过。</li>
          </ul>
        </div>
      </div>
