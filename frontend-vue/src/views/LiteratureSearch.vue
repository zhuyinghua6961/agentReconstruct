  ...
  <div class="literature-search-page">
    ...
    <section class="search-panel">
      ...
      <div class="options-grid">
        ...
        <label class="option-field">
          <span>数据源</span>
          <select v-model="sources">
            <option value="both">全部</option>
            <option value="fastqa">FastQA 主库</option>
            <option value="fastqa_md">FastQA MD</option>
            <option value="highthinking">深度模式</option>
          </select>
        </label>
      </div>
    </section>
