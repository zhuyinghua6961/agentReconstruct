...
_ROUTE_SPECS: tuple[tuple[tuple[str, ...], tuple[str, ...]], ...] = (
    ...
    (_paths("/api/admin/personnel/{personnel_id}", include_v1=False), ("PUT", "DELETE")),
    ...
    (_paths("/api/admin/personnel/batch-delete", include_v1=False), ("POST",)),
    (_paths("/api/admin/personnel/batch-status", include_v1=False), ("POST",)),
    (_paths("/api/admin/personnel/batch-department", include_v1=False), ("POST",)),
    (_paths("/api/admin/personnel/{personnel_id}/force-delete", include_v1=False), ("POST",)),
    (_paths("/api/admin/personnel/batch-force-delete", include_v1=False), ("POST",)),
    ...
    (_paths("/api/admin/departments/primary/{primary_id}", include_v1=False), ("PUT", "DELETE")),
    (_paths("/api/admin/departments/primary/{primary_id}/status", include_v1=False), ("PUT",)),
    (_paths("/api/admin/departments/primary/{primary_id}/direct-users", include_v1=False), ("GET",)),
    (_paths("/api/admin/departments/secondary", include_v1=False), ("POST",)),
    (_paths("/api/admin/departments/secondary/{secondary_id}", include_v1=False), ("PUT", "DELETE")),
    (_paths("/api/admin/departments/secondary/{secondary_id}/status", include_v1=False), ("PUT",)),
    (_paths("/api/admin/departments/secondary/{secondary_id}/direct-users", include_v1=False), ("GET",)),
    ...
    (_paths("/api/admin/departments/tertiary/{tertiary_id}", include_v1=False), ("PUT", "DELETE")),
    ...
    (_paths("/api/admin/departments/batch-delete", include_v1=False), ("POST",)),
    (_paths("/api/admin/departments/batch-status", include_v1=False), ("POST",)),
    (_paths("/api/admin/departments/{level}/{department_id}/force-delete", include_v1=False), ("POST",)),
