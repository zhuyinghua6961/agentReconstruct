...
REQUIRED_COLUMNS = ["employee_no", "full_name", "verification_code", "status"]
...
class PersonnelImportService:
    def __init__(
        ...
        *,
        ...
        service: PersonnelService | None = None,
    ) -> None:
    ...
    def template_response(self, *, fmt: str) -> Response | dict[str, Any]:
        ...
        rows = [
            ["T2024001", "张三", "ABC123", "active", "化学学院"],
            ["T2024002", "李四", "XYZ789", "disabled", "材料系"],
        ]
